...
namespace demo.reporter
{
    class Reporter
    {
        ...
        {
            //test = extent.CreateTest(TestExecutionContext.CurrentContext.CurrentTest.Properties.Get("TestName").ToString());
            test = extent.CreateTest(TestExecutionContext.CurrentContext.CurrentTest.Name);
            test.AssignCategory(TestExecutionContext.CurrentContext.CurrentTest.Properties.Get("Category").ToString());
